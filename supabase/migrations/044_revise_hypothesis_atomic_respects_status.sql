...
create or replace function revise_hypothesis_atomic(
  ...
  p_prev_id uuid,
  p_new_row jsonb
) returns public.trait_hypothesis_history
language plpgsql security definer set search_path = '' as $$
declare
  v_new_id uuid;
  v_result public.trait_hypothesis_history%rowtype;
begin
  ...
  insert into public.trait_hypothesis_history (
  ...
  update public.trait_hypothesis_history
